...
export default function ReputationInsights({ userId }) {
  ...
  if (loading) {
    return (
      <div className="p-6 bg-white dark:bg-slate-900 shadow-sm dark:shadow-none border border-slate-800 rounded-3xl">
        <div className="flex items-center justify-center py-12">
          <FiLoader className="text-indigo-400 animate-spin text-2xl mr-3" />
          <p className="text-slate-500 dark:text-white/60">AI analyzing your reputation…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 border border-indigo-500/30 rounded-3xl p-8">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">AI Reputation Guide</h2>
            ...
            <div className="flex gap-4 mt-4 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-600 dark:text-white/70">Identify Your Strengths</span>
              </div>
              <div className="flex items-center gap-2">
                <FiTarget className="text-purple-400" size={16} />
                <span className="text-xs text-slate-600 dark:text-white/70">Set Clear Goals</span>
              </div>
              <div className="flex items-center gap-2">
                <FiZap className="text-amber-400" size={16} />
                <span className="text-xs text-slate-600 dark:text-white/70">Get AI Recommendations</span>
              </div>
            </div>
          </div>
          <div className="text-right flex-shrink-0">
            <div className="text-3xl font-bold text-slate-900 dark:text-white mb-1">{data.score}</div>
            <div className="text-xs text-slate-500 dark:text-white/50 font-semibold uppercase tracking-widest px-3 py-1 bg-indigo-500/20 border border-indigo-500/20 rounded-lg inline-block">{data.tier} Tier</div>
          </div>
        </div>
      </div>
        ...
        <button
          ...
          className={`px-4 py-3 text-sm font-semibold transition whitespace-nowrap ${
            activeTab === 'explanation'
              ...
              : 'text-slate-500 dark:text-white/50 hover:text-slate-600 dark:hover:text-white/70'
          }`}
        >
        ...
        {activeTab === 'explanation' && (
          <div className="space-y-4">
            ...
            {data.scoreExplanation.length > 0 && (
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="space-y-4">
            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white text-lg">Your Key Strengths</h3>
                  <p className="text-slate-500 dark:text-white/60 text-sm">What you do exceptionally well</p>
                </div>
              </div>
            </div>
            ...
            {data.aiExplanation && (
              <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-5">
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Strong Areas</h3>
                    <p className="text-slate-600 dark:text-white/70 leading-relaxed text-sm whitespace-pre-line">
                      {data.aiExplanation}
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-center">
                <div className="text-sm text-slate-500 dark:text-white/50 mb-2">Avg Rating</div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-center">
                <div className="text-sm text-slate-500 dark:text-white/50 mb-2">Sessions</div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-center">
                <div className="text-sm text-slate-500 dark:text-white/50 mb-2">Badges</div>
          ...
          <div className="space-y-4">
            <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white text-lg">Areas for Improvement</h3>
                  <p className="text-slate-500 dark:text-white/60 text-sm">Opportunities to grow and develop</p>
                </div>
              </div>
            </div>
            ...
            {data.scoreExplanation && data.scoreExplanation.length > 0 && (
              <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-5">
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 dark:text-white mb-3">AI Analysis of Development Areas</h3>
                    <div className="space-y-2">
                      {data.scoreExplanation.map((item, idx) => (
                        <div key={idx} className="flex items-start gap-3 text-sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4">
                ...
                <div className="text-xs text-slate-500 dark:text-white/60">Focus on clear, timely responses</div>
              </div>
              <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-4">
                <div className="text-sm text-orange-300 font-semibold mb-2">Consistency</div>
                <div className="text-xs text-slate-500 dark:text-white/60">Maintain steady performance</div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white text-lg">Your Reputation Goals</h3>
                  <p className="text-slate-500 dark:text-white/60 text-sm">Concrete targets to achieve your next tier</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-5">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600 dark:text-white/70">Current Progress</span>
                  <span className="text-green-400 font-bold">{data.pointsToNextTier} points to go</span>
                </div>
                <div className="w-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/50 rounded-full h-3 overflow-hidden">
                  <div
            ...
            {/* Smart Goals */}
            <div className="space-y-3">
              <h3 className="font-semibold text-slate-900 dark:text-white text-sm">SMART Goals Breakdown:</h3>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Specific</div>
                    <div className="text-xs text-slate-500 dark:text-white/60">Improve communication clarity rating from 3.5 to 4.5</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Measurable</div>
                    <div className="text-xs text-slate-500 dark:text-white/60">Track average ratings on each peer review</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Achievable</div>
                    <div className="text-xs text-slate-500 dark:text-white/60">Take on 5+ new tasks with focus on clear communication</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Relevant</div>
                    <div className="text-xs text-slate-500 dark:text-white/60">Critical for reaching Elite status and building trust</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm mb-1">Time-bound</div>
                    <div className="text-xs text-slate-500 dark:text-white/60">Achieve this milestone within 30 days</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'improvement' && (
          <div className="space-y-4">
            ...
            <div className="bg-green-500/10 border border-green-500/20 rounded-2xl p-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-slate-600 dark:text-white/70">Progress to next tier</span>
                  <span className="text-green-400 font-bold">{data.pointsToNextTier} points needed</span>
                </div>
                <div className="w-full bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/50 rounded-full h-2">
                  <div
            ...
            {data.aiImprovementPlan && (
              <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-2xl p-5">
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-900 dark:text-white mb-2">AI-Powered Plan</h3>
                    <p className="text-slate-600 dark:text-white/70 text-sm whitespace-pre-line leading-relaxed">
                      {data.aiImprovementPlan}
                    </p>
                  </div>
                </div>
            ...
            {data.suggestions.length > 0 && (
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-2xl p-5">
                <h3 className="font-semibold text-slate-900 dark:text-white mb-3">Quick Tips</h3>
                <div className="space-y-2">
                  {data.suggestions.map((suggestion, idx) => (
                    <div key={idx} className="flex items-start gap-3 text-sm">
                      <span className="text-amber-400 mt-1 font-bold">→</span>
                      <span className="text-slate-600 dark:text-white/70">{suggestion}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-4">
            {anomalies.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 dark:text-white/50">No anomalies detected. Keep up the good work! 🎉</p>
              </div>
            ) : (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-slate-600 dark:text-white/70 text-sm">{anomaly.message}</p>
                    </div>
                  </div>
                </div>
              ))
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-2xl p-6">
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  <div className="text-sm text-slate-500 dark:text-white/50 mb-1">Current</div>
                  <div className="text-2xl font-bold text-slate-900 dark:text-white">{prediction.data.currentScore}</div>
                ...
                <div className="text-center">
                  <div className="text-sm text-slate-500 dark:text-white/50 mb-1">In 7 Days</div>
              ...
              <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/50 rounded-xl p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4 text-center">
          <div className="text-sm text-slate-500 dark:text-white/50 mb-1">Avg Rating</div>
          <div className="text-xl font-bold text-amber-400">{data.stats.avgRating}/5</div>
        </div>
        <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4 text-center">
          <div className="text-sm text-slate-500 dark:text-white/50 mb-1">Sessions</div>
          <div className="text-xl font-bold text-blue-400">{data.stats.totalRatings}</div>
        </div>
        <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4 text-center">
          <div className="text-sm text-slate-500 dark:text-white/50 mb-1">Endorsements</div>
          <div className="text-xl font-bold text-indigo-400">{data.stats.endorsementCount}</div>
        </div>
        <div className="bg-white dark:bg-slate-900 shadow-sm dark:shadow-none/40 border border-slate-800 rounded-xl p-4 text-center">
          <div className="text-sm text-slate-500 dark:text-white/50 mb-1">Badges</div>
